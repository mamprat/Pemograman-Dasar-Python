# Create by Imam Pratama Setiady 20/11/2021
...
ket = LabelFrame(root,text = "Data Karyawan Tersimpan",padx=20,pady=20)
ket.place(x = 20,y = 220)
...
def regis():
    data = [nama.get(), nip.get(),email.get(), asal.get(), rgender.get(), rdivisi.get(), rshift.get()]
